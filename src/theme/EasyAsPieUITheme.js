...
export const EasyAsPieUITheme = ({ colors = {}, spacing = {} }) => {
  Object.keys(Colors).map(
    (key) =>
      (Colors[key] = colors.hasOwnProperty(key) ? colors[key] : Colors[key])
  )
  Object.keys(Spacing).map(
    (key) =>
      (Spacing[key] = spacing.hasOwnProperty(key) ? spacing[key] : Spacing[key])
  )
    ...
    <Global
      styles={css`
        ...
        *::after {
        ...
        /* Box Shadows */
        .box-shadow {
          box-shadow: 0 1px 3px ${Colors.black};
        }
        ...
        ${Object.keys(Colors).map((key) => {
          ...
          currentHSL[2] *= currentHSL[2] * 0.8 < 10 ? 1.8 : 0.8
