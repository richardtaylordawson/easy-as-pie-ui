...
var ReactCuttlefishTheme = function ReactCuttlefishTheme(_ref) {
  ...
  return React.createElement(Global, {
    styles: css(_templateObject, Breakpoints_1["small-up"], Breakpoints_1["medium-up"], Breakpoints_1["large-up"], Breakpoints_1["large-up"], Breakpoints_1["large-up"], Colors_1.black, Breakpoints_1["medium-down"], Breakpoints_1["large-up"], Object.keys(Colors_1).map(function (key) {
    ...
    }), Spacing_1.xs, Spacing_1.sm, Spacing_1.md, Spacing_1.lg, Spacing_1.xl, Spacing_1.xs, Spacing_1.sm, Spacing_1.md, Spacing_1.lg, Spacing_1.xl, Spacing_1.xs, Spacing_1.sm, Spacing_1.md, Spacing_1.lg, Spacing_1.xl, Spacing_1.xs, Spacing_1.sm, Spacing_1.md, Spacing_1.lg, Spacing_1.xl)
  });
};
